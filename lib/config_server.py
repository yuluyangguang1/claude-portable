...
PROVIDERS = [
    ...
    # ── cc-switch 集成: Anthropic 兼容 Provider ──
    {"id": "kimi-for-coding", "name": "Kimi For Coding", "base_url": "https://api.kimi.com/coding/",
     "models": ["kimi-for-coding"],
     "key_hint": "粘贴 Kimi API Key", "note": "Kimi 代码专用，256K context"},
    {"id": "ark-agentplan", "name": "火山 Agentplan", "base_url": "https://ark.cn-beijing.volces.com/api/coding",
     "models": ["ark-code-latest"],
     "key_hint": "粘贴火山引擎 API Key", "note": "火山引擎代码专用"},
    {"id": "byteplus", "name": "BytePlus", "base_url": "https://ark.ap-southeast.bytepluses.com/api/coding",
     "models": ["ark-code-latest"],
     "key_hint": "粘贴 BytePlus API Key", "note": "火山海外版"},
    {"id": "doubao-seed", "name": "DouBaoSeed", "base_url": "https://ark.cn-beijing.volces.com/api/compatible",
     "models": ["doubao-seed-2-1-pro"],
     "key_hint": "粘贴火山引擎 API Key", "note": "豆包 Seed 2.1 Pro"},
    {"id": "qianfan", "name": "百度千帆", "base_url": "https://qianfan.baidubce.com/anthropic/coding",
     "models": ["ernie-4.5-turbo-128k"],
     "key_hint": "粘贴百度 API Key", "note": "百度千帆代码版"},
    {"id": "bailian", "name": "阿里百炼", "base_url": "https://dashscope.aliyuncs.com/apps/anthropic",
     "models": ["qwen3-coder-plus", "qwen3-max"],
     "key_hint": "粘贴阿里云 API Key", "note": "阿里百炼平台"},
    {"id": "bailian-coding", "name": "百炼代码版", "base_url": "https://coding.dashscope.aliyuncs.com/apps/anthropic",
     "models": ["qwen3-coder-plus", "qwen3-max"],
     "key_hint": "粘贴阿里云 API Key", "note": "百炼代码专用"},
    {"id": "stepfun-plan", "name": "阶跃星辰计划", "base_url": "https://api.stepfun.com/step_plan",
     "models": ["step-3.7-flash", "step-3.5-flash"],
     "key_hint": "粘贴阶跃星辰 API Key", "note": "阶跃星辰计划版"},
    {"id": "kat-coder", "name": "KAT-Coder", "base_url": "https://vanchin.streamlake.ai/api/gateway/v1",
     "models": ["KAT-Coder-Pro-V1", "KAT-Coder-Air-V1"],
     "key_hint": "粘贴 KAT-Coder API Key", "note": "流水灯代码模型"},
    {"id": "longcat", "name": "LongCat", "base_url": "https://api.longcat.chat/anthropic",
     "models": ["LongCat-2.0"],
     "key_hint": "粘贴 LongCat API Key", "note": "LongCat 2.0"},
    {"id": "bailing", "name": "百灵", "base_url": "https://api.tbox.cn/api/anthropic",
     "models": ["Ling-2.5-1T"],
     "key_hint": "粘贴百灵 API Key", "note": "支付宝百灵"},
    {"id": "xiaomi-token", "name": "小米 MiMo Token Plan", "base_url": "https://token-plan-cn.xiaomimimo.com/anthropic",
    ...
    {"id": "modelscope", "name": "ModelScope", "base_url": "https://api-inference.modelscope.cn",
     ...
     "key_hint": "粘贴 ModelScope API Key", "note": "魔搭社区"},
    {"id": "nvidia-claude", "name": "NVIDIA", "base_url": "https://integrate.api.nvidia.com",
